...
urlpatterns = [
    ...
    path(
        ...
        views.update_session_character,
        name="update_session_character",
    ),
    ...
    path(
        "rulebook/",
        views.handbook_section,
        {"section": "public_rulebook"},
        name="rulebook",
    ),
    path(
        "turn-sequence/",
        views.serve_reference_html,
        {"filename": "pillars-turn-sequence.html"},
        name="turn_sequence",
    ),
    ...
    path(
        "character/<int:char_id>/update/",
        views.update_character,
        name="update_character",
    ),
    path(
        "character/<int:char_id>/add-experience/",
    ...
    path(
        "manage-characters/bulk-delete/",
        views.bulk_delete_characters,
        name="bulk_delete_characters",
    ),
    path("admin-notes/", views.admin_notes, name="admin_notes"),
    path(
        "admin-notes/<int:note_id>/edit/", views.admin_edit_note, name="admin_edit_note"
    ),
    path(
    ...
    path(
        "admin-delete-character/<int:char_id>/",
        views.admin_delete_character,
        name="admin_delete_character",
    ),
]
