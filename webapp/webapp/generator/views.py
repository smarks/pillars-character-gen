...
def reference_html(request, name):
    """Serve pre-rendered HTML content wrapped in the base template.

    This provides consistent navigation across all HTML reference pages.
    The HTML files are content-only fragments generated by build_rulebook.py.
    """
    # Security: prevent directory traversal
