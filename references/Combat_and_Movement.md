...
| 3     | **Initial Movement** | Character with highest initiative either moves, or yields.<br/>Movement stops upon engagement.<br/>Repeat for each character by initiative. |
| 4     | **Final Movement**   | Characters who yielded move after characters who did not yield move, by initiative.   
...
**Exhaustion:** When fatigue spent equals CON, you are **exhausted**:
...
| Roll | Result                                                    |
|------|-----------------------------------------------------------|
| 3 | Automatic hit, **triple** damage/effect  special critical |
| 4 | Automatic hit, **double** damage/effect, bleeding         |
| 5 | Automatic hit                                             |
| 16 | Automatic miss                                            |
...
| 14 | Hit an unintended target in path of missile |
...
| Body Points reduced to -CON | CON check when failed -> Dead                          |
| Took 7+ hits in one turn    | −2 DX next turn                                        |
| Took 15+ hits in one turn   | DEX check Fall down immediately, lose action this turn |
